...
pub fn Footer() -> Element {
    rsx! {
        footer { class: "relative mt-auto min-h-[340px] overflow-hidden border-t border-dashed border-primary-6 bg-transparent",
            ...
            div { class: "relative z-10 space-y-8 px-6 py-8 md:px-10",
                div { class: "grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-12",
                    ...
                    nav { class: "space-y-3 md:col-span-1 lg:col-span-4", aria_label: "Footer Index",
